...
| `acw.track3.viewprefs.v1` | `acw-track3-viewprefs-1.0` | `acw/track3/track3ViewPrefs.ts` | View mode, perspective, hidden layers, camera (per architecture; legacy `byBinding` map still validated for back-compat) |
