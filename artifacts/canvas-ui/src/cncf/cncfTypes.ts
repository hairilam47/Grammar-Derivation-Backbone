...
// parameter ids declared in `ctadRegistry`.
//
...
//
// The catalog is bundled, never fetched. All paramId / option
// strings are validated against the live CTAD registry at module
// load by `cncfCatalog.ts`; an unknown id or option fails the
// bundle.
